...
def main(config):
    ...
    arl_sample_dfs, arl_constant_array_lakes, arlie_stats_df_z = calculate_stats_per_lake(arlie_dict, gwp_column = "zscore-gwp-area-km2", validation_column = "zscore-validation-water-perc", number_of_samples=50, use_zscore=True)
    
    nasa_sample_dfs, nasa_constant_array_lakes, nasa_stats_df_z = calculate_stats_per_lake(nasa_dict, gwp_column = "zscore-gwp-perc", validation_column = "zscore-validation-water-perc", number_of_samples=50, use_zscore=True)
    li_sample_dfs, li_constant_array_lakes, li_stats_df_z = calculate_stats_per_lake(li_dict, gwp_column = "zscore-gwp-area-km2", validation_column = "zscore-li-water-km2", number_of_samples=10, use_zscore=True)
    ...
    arl_sample_dfs, arl_constant_array_lakes, arlie_stats_df = calculate_stats_per_lake(arlie_dict, gwp_column = "gwp-water-perc", validation_column = "validation-water-perc", number_of_samples=50, use_zscore=False)
    nasa_sample_dfs, nasa_constant_array_lakes, nasa_stats_df = calculate_stats_per_lake(nasa_dict, gwp_column = "gwp-water-perc", validation_column = "validation-water-perc", number_of_samples=50, use_zscore=False)
    li_sample_dfs, li_constant_array_lakes, li_stats_df = calculate_stats_per_lake(li_dict, gwp_column = "gwp-water-perc", validation_column = "validation-water-perc-li", number_of_samples=10, use_zscore=False)
    ...
    # Benenne _z Spalten um (entferne _z Suffix)
